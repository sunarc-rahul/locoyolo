    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-calendar"></i> Ping Management
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Ping List</h3>
                    <div class="box-tools">
                  ...
                  <table class="table table-hover">
                    ...
                    ?>
                      ...
                      <td class="text-center">
                          ...
                          <a class="btn btn-sm btn-info" href="<?php echo base_url().'ping/view/'.$record->id; ?>"><i class="glyphicon glyphicon-eye-open"></i></a>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", "<?php echo site_url();?>" + "pings/" + value);
    ...
    $('.deleteUserbtn').click(function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('deletePing')?>",
            data: {id:id}
        }).done(function( res ) {
